...
import legend_of_xor.Renderer.Layers.DebugText;
...
public class KeyboardLisenter extends Controls {
    ...
    protected static boolean jumpPressed, rightPressed,
            ...
            pausePressed, showDebugTextPressed, showHitboxesPressed;
    ...
    public static void init(JComponent mouseArea, Frame frame) {
        ...
        frame.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
                ...
                pausePressed = ke.getKeyChar() == Controls.pauseKey;

                if (Controls.isShowDebugTextPressed()){
                    DebugText.showDebugText = !DebugText.showDebugText;
                }
                if (Controls.isShowHitboxesPressed()){
                    HitBoxLayer.showHitboxes = !HitBoxLayer.showHitboxes;
                }
            }
            ...
            public void keyPressed(KeyEvent ke) {
                ...
                if (Character.toLowerCase(ke.getKeyChar()) == Controls.showHitboxesKey) {
                    showHitboxesPressed = true;
                }
                if (Character.toLowerCase(ke.getKeyChar()) == Controls.showDebugTextKey) {
                    showDebugTextPressed = true;
                }
            }
            ...
            public void keyReleased(KeyEvent ke) {
                ...
                if (Character.toLowerCase(ke.getKeyChar()) == Controls.showHitboxesKey) {
                    showHitboxesPressed = false;
                }
                if (Character.toLowerCase(ke.getKeyChar()) == Controls.showDebugTextKey) {
                    showDebugTextPressed = false;
                }
            }
        });
    }
