...
public class Controls {
    ...
    protected static char jumpKey = ' ', rightKey = 'd', leftKey = 'a',
            ...
            magicKey = 'i', pauseKey = 27, inventoryKey = 'e', showDebugTextKey = 'g', showHitboxesKey = 'h';
    ...
    public static boolean isShowDebugTextPressed() {
        switch (controlTypeInUse) {
            case KEYBOARD:
                return KeyboardLisenter.showDebugTextPressed;
            case CONTROLLER:
                break;
            default:
                return false;
    ...
    public static boolean isShowHitboxesPressed() {
        switch (controlTypeInUse) {
            case KEYBOARD:
                return KeyboardLisenter.showHitboxesPressed;
            case CONTROLLER:
                break;
            default:
                return false;
